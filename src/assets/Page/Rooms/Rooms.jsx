...
useEffect(()=>{
    axios.get(`http://localhost:5000/rooms?sortvalue=${sortvalue}`)
    .then(res =>{
   setRooms(res.data)
    })
},[sortvalue])
    ...
    return (
      <div className="bg-[#010313] min-h-[100vh] dark:bg-[white]">
        ...
        <div className=" mt-10 flex">
          <select onChange={handleSort} className="select btn-two bg-[#03131F]  select-success  w-full mx-auto lg:max-w-[80%]">
