      ...
      <div>
        <div className="card  w-full lg:w-[350px]    hover:bg-gradient-to-t hover:from-[#10807a]  hover:to-[#03131F]  duration-300      text-white cursor-pointer bg-gradient-to-b from-[#156f83] to-[#030816] ">
          ...
          <div className="card-body  font-bold  ">
            ...
            <button className='btn-sm btn bg-gray-500 border-none  hover:bg-gray-400 text-white w-[50%] '><span className='text-white'>availables</span></button>
          </div>
          ...
          <div className=" mb-10  mt-1 text-center  px-2 md:px-5  ">
              ...
              <button onClick={handleDetails} className="btn w-full   text-xl text-center btn-three bg-transparent border-white">
                Booking
              </button>
