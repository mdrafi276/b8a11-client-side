              ...
              <div className="container mx-auto xl:px-32">
                <div className="grid items-center gap-12 lg:grid-cols-2">
                  ...
                  <div className="mb-12 lg:mb-0">
                    <div className="relative h-one bg-[hsla(0,0%,100%,0.9)] backdrop-blur-[25px] backdrop-saturate-[200%] block rounded-lg px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,15%,0.9)] dark:shadow-black/20 md:px-12">
                      ...
                      <form>
                        ...
                        >
                          <input
                            type="text"
                            placeholder="name"
                            className="input bg-transparent font-extrabold h-one  input-bordered input-error w-full max-w-xs"
                          />
                          <input
                            type="text"
                            placeholder="email"
                            className="input mt-3 h-one font-extrabold bg-transparent input-bordered input-error w-full max-w-xs"
                          />
